...
public class GPS_P extends AppCompatActivity
    ...
    EditText Ed3;
    EditText Ed4;
    EditText Ed_ChildLat, Ed_ChildLon;
    ...
    private Marker currentMarkerChild = null;
...
//         EtGPS = (EditText)findViewById(R.id.etgps);
    ...
    public void setCurrentLocation(final Location location, String markerTitle, String markerSnippetChild, String markerSnippet1) {
        ...
        Ed_ChildLat = (EditText) findViewById(R.id.etChildLat);
        Ed_ChildLon = (EditText) findViewById(R.id.etChild_Lon);
...
//        }
        ...
        markerOptions.title("아이의 위치");
        markerOptions.snippet(markerSnippetChild);
        markerOptions.draggable(true);
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.child1));
        currentMarkerChild = mGoogleMap.addMarker(markerOptions);
    ...
    class NetWorkSend2 extends AsyncTask {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, CONNECT_IP, new com.android.volley.Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        Log.d("findLocation", "서버에서 받은 위도 경도 " + latitude + " , " + longitude + " 배터리 잔량 : " + battery);
                        Toast.makeText(GPS_P.this, "db조회 위도 : " + latitude + " 경도 : " + longitude + " 이며, 자녀의 배터리 잔량은 " + battery + "% 입니다.", Toast.LENGTH_SHORT).show();
        ...
        public void connectChild() {
            String CONNECT_IP = "http://192.168.137.98:3000/process/connectChild";
            StringRequest request = new StringRequest(Request.Method.POST, CONNECT_IP, new com.android.volley.Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    try {
